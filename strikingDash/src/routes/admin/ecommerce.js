...
const OrderEdit = lazy(() => import('../../container/ecommerce/product/EditOrder'));
...
const DesignList = lazy(() => import('../../container/ecommerce/DesignList'));
