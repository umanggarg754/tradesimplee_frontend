...
function CreateTemplate() {
  ...
  const handleCheckboxChangeProduct = (name) => {
    setCreateOrderJSONData((prevData) => {
                              ...
                              <div className="add-product-content">
                                <Cards title="Template Form">
                                  ...
                                  <Form.Item label="Document Type">
                                    ...
                                    style={{ width: '100%' }}
                                    onChange={(e)=>{
                                      setCreateOrderJSONData({
                                        ...createOrderJSONData,
                                        type: e,
                                      });
                                    }}
                                    value = {createOrderJSONData.type}
                                    >
                                      <Option value="invoice" key="invoice">
                                        Invoice
                                      </Option>
                                      <Option value="design-list" key="number">
                                        Design List
                                      </Option>
                                    </Select>
                                  </Form.Item>
                                ...
                                {templateDetails.map((elem, index) => (
                                  <div>
                                    <Checkbox
                                      ...
                                      type="checkbox"
                                      value={elem.name}
                                      checked={createOrderJSONData.details.product_details?.includes(elem.name)}
                                      onChange={() => handleCheckboxChangeProduct(elem.name)}
                                    >
                                      {elem.name}
                                    </Checkbox>
                                </div>
